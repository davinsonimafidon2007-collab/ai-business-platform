...
const navigation: NavItem[] = [
  ...
  { name: "Oportunidades", href: "/opportunities/", icon: "opportunities" },
  { name: "Órdenes", href: "/orders/", icon: "orders" },
  { name: "Inspección", href: "/inspection/", icon: "inspection" },
  { name: "Historial", href: "/history/", icon: "history" },
];

const adminNavigation: NavItem[] = [
  { name: "Configuración", href: "/admin/", icon: "config" },
  { name: "API keys", href: "/api-keys/", icon: "api" },
];
...
export function Sidebar() {
  ...
  return (
    <aside className="fixed left-0 top-0 z-40 flex h-screen w-64 flex-col border-r border-secondary-200 bg-white dark:border-secondary-800 dark:bg-secondary-900">
