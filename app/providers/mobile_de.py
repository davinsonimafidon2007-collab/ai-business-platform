...
class MobileDeProvider(VehicleProvider):
    ...
    estructura preparada para la futura integración con mobile.de.
    """
    ...
    async def search(self, query: str, **kwargs: object) -> list[VehicleSearchResult]:
        """Busca vehículos en mobile.de.

        Ejemplo de uso:
            async with MobileDeProvider() as provider:
        ...
        raise NotImplementedError("Mobile.de scraping is not implemented yet")

    async def get_vehicle(self, external_id: str) -> VehicleDetail:
        """Obtiene un vehículo detallado de mobile.de.
    ...
    def normalize_vehicle(self, raw_data: dict) -> VehicleSearchResult | VehicleDetail:
        """Normaliza los datos crudos de mobile.de a un DTO.
